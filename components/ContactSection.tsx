...
const contactLinks = [
  {
    name: 'Email',
    href: 'mailto:linrui@mit.edu',
    label: 'linrui@mit.edu',
  ...
  {
    name: 'Phone',
    href: 'tel:+16172568650',
    label: '+1 (617) 256-8650',
          ...
          {contactLinks.map((link, index) => (
            ...
            >
              ...
              <div className="min-w-0">
                <div className="font-medium text-sm text-neutral-900 dark:text-white group-hover:text-primary-600 dark:group-hover:text-primary-400 transition-colors">
                  {link.label}
                </div>

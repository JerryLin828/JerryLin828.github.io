      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="flex items-center gap-4">
            {socialLinks.map((social) => (
              <a
                ...
                className="text-neutral-400 dark:text-neutral-500 hover:text-primary-600 dark:hover:text-primary-400 transition-colors"
        ...
        <div className="mt-6 pt-6 border-t border-neutral-200 dark:border-neutral-800 text-center">
          <p className="text-xs text-neutral-400 dark:text-neutral-500">
            &copy; {new Date().getFullYear()} Linrui Ma
          </p>
        </div>
      </div>
    </footer>

...
const projects: Project[] = [
  {
    ...
    description: 'Novel protein function annotation framework combining 3D structural information with sequence-based methods, achieving 114% performance improvement on Meta-BLEU-2.',
    githubUrl: 'https://github.com/winstonqian/SAPER',
  },
  {
    id: 2,
    title: 'Multilingual Mathematical Reasoning in Neural Networks',
    description: 'Research on how representation choice affects neural reasoning efficiency in Transformers, achieving 5-10% token efficiency gains across GSM8K and MMATH benchmarks.',
    githubUrl: 'https://github.com/bowenyu066/language-shapes-reasoning',
  },
  {
    id: 3,
    title: 'Labotex: AI-Powered Lab Report Generator',
    description: 'Intelligent agent that streamlines LaTeX lab report generation from raw data by integrating VLMs and chat models to convert experiment PDFs and CSV datasets into structured scientific reports.',

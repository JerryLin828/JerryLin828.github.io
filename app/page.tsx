...
export default function HomePage() {
  return (
    <div className="relative">
      ...
      <section id="publications" className="relative py-12 sm:py-20 bg-gradient-to-br from-neutral-50 via-primary-50/20 to-secondary-50/20 dark:from-[#050510] dark:via-[#0a0a1a] dark:to-[#080818] overflow-hidden">
        <div className="absolute inset-0 overflow-hidden">
          <div className="absolute -top-40 -right-40 w-80 h-80 bg-primary-300/30 dark:bg-primary-800/15 rounded-full blur-3xl animate-float" />
          <div className="absolute -bottom-40 -left-40 w-80 h-80 bg-secondary-300/30 dark:bg-secondary-800/15 rounded-full blur-3xl animate-float animation-delay-2000" />
        </div>
      ...
      {/* Portfolio Section */}
      <section id="portfolio" className="py-12 sm:py-20 bg-neutral-50/80 dark:bg-[#0a0a12]">
        <PortfolioSection />
      </section>

      {/* Experience Section */}
      <section id="experience" className="relative py-12 sm:py-20 bg-gradient-to-br from-neutral-50 via-primary-50/20 to-secondary-50/20 dark:from-[#050510] dark:via-[#0a0a1a] dark:to-[#080818] overflow-hidden">
        <div className="absolute inset-0 overflow-hidden">
      ...
      {/* Awards Section */}
      <section id="awards" className="py-12 sm:py-20 bg-neutral-50/80 dark:bg-[#0a0a12]">
        <AwardsSection />
      </section>

      {/* Contact Section */}
      <section id="contact" className="relative py-12 sm:py-20 bg-gradient-to-br from-neutral-50 via-primary-50/20 to-secondary-50/20 dark:from-[#050510] dark:via-[#0a0a1a] dark:to-[#080818] overflow-hidden">
        <div className="absolute inset-0 overflow-hidden">
          <div className="absolute -top-40 -right-40 w-80 h-80 bg-primary-300/30 dark:bg-primary-800/15 rounded-full blur-3xl animate-float" />
          <div className="absolute -bottom-40 -left-40 w-80 h-80 bg-secondary-300/30 dark:bg-secondary-800/15 rounded-full blur-3xl animate-float animation-delay-2000" />
        </div>
